...
class MixtureColor:
    ...
    Attributes:
        ...
        raw_rf_values (List[float]): Calculated Rf values for the color channel.
    """
    def __init__(self, channel_image: np.ndarray):
        """
        Initializes the MixtureColor with a given channel image.
        ...
        try:
            ...
            log.error(f'Error initializing MixtureColor: {e}')
            raise
...
class Mixture:
    ...
    Attributes:
        ...
        red_channel_mixture (MixtureColor): MixtureColor for the red channel.
        green_channel_mixture (MixtureColor): MixtureColor for the green channel.
        blue_channel_mixture (MixtureColor): MixtureColor for the blue channel.
    """
    ...
    def __init__(self, name: str, image: np.ndarray):
        ...
        try:
            ...
            self.log.debug(f'Initiate MixtureColor: Red channel ')
            self.red_channel_mixture = MixtureColor(self.detected_line_image[:, :, 0])
            
            self.log.debug(f'Initiate MixtureColor: Green channel')
            self.green_channel_mixture = MixtureColor(self.detected_line_image[:, :, 1])
            
            self.log.debug(f'Initiate MixtureColor: Blue channel')
            self.blue_channel_mixture = MixtureColor(self.detected_line_image[:, :, 2])
    ...
    def get_channel_image(self, color: str) -> np.ndarray:
        """
        Returns the channel image for a given color.

        Args:
            color (str): Color channel to retrieve.

        Returns:
            np.ndarray: Image array of the color channel.
        """
        if color == 'red':
            return self.red_channel_mixture.channel_image
        elif color == 'green':
            return self.green_channel_mixture.channel_image
        elif color == 'blue':
            return self.blue_channel_mixture.channel_image
        else:
            raise ValueError(f'Invalid color: {color}')
    
    def get_segmented_image(self, color: str) -> np.ndarray:
        """
        ...
        """
        if color == 'red':
            return self.red_channel_mixture.segmented_image
        elif color == 'green':
            return self.green_channel_mixture.segmented_image
        elif color == 'blue':
            return self.blue_channel_mixture.segmented_image
        else:
            raise ValueError(f'Invalid color: {color}')
    
    def get_rf(self, color: str) -> List[float]:
        """
        ...
        """
        if color == 'red':
            return self.red_channel_mixture.rf
        elif color == 'green':
            return self.green_channel_mixture.rf
        elif color == 'blue':
            return self.blue_channel_mixture.rf
        else:
            raise ValueError(f'Invalid color: {color}')